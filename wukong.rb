...
class Wukong < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "9efe0af916f432ed8a735d496fa9b09476661eb41f372f606e65d6cfb3277299"
    end

    on_intel do
      url "https://github.com/mindvalley/wukong-cli/releases/download/#{version}/wukong-v#{version}-macOS-x86.tar.gz"
      sha256 "e8aa9021c2294bc9c325a095c5525ef00fe6538c9f5ea4765267110e9829b10f"
    end
  end

  on_linux do
    url "https://github.com/mindvalley/wukong-cli/releases/download/#{version}/wukong-v#{version}-linux-x86.tar.gz"
    sha256 "75925bef1e3a69e2f0159f0a6d5ae9ffa9cd34cb96babccf09a9a0c0b5a9f1dd"
  end

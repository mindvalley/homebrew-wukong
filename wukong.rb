...
class Wukong < Formula
  ...
  on_macos do
    on_arm do
      ...
      sha256 "be0157c708821b6996046de695e3ef23f1ac35184140825a23e34bbce86759d9"
    end

    on_intel do
      url "https://github.com/mindvalley/wukong-cli/releases/download/#{version}/wukong-v#{version}-macOS-x86.tar.gz"
      sha256 "397ed98d9d0423965daef73afc612c047b2c8ed99aec70c963d1b1430ca96267"
    end
  end

  on_linux do
    url "https://github.com/mindvalley/wukong-cli/releases/download/#{version}/wukong-v#{version}-linux-x86.tar.gz"
    sha256 "90ec722be26d2d33446aaa98010f34b244e61187447afdf2969047a1e3ad4715"
  end
